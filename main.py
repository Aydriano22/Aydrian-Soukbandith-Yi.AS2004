...
list_questions1 = ["Who directed Hunt for the wilderpeople movie? "]
list_questions2 = ["Who played Ricky Baker? "]
list_questions3 = ["Who played Uncle Hec? "]
list_questions4 = ["Did Aunt Bella die in Hunt for the wilderpeople? "]
list_questions5 = ["What crimes did Ricky Baker commit? "]
list_questions6 = ["What year did Hunt for the wilderpeople come out? "]
